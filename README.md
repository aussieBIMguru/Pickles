...
Pickles provides over **300 general-purpose Revit utility nodes**, covering a wide range of common tasks and Revit API functionality.
...
Pickles includes a dedicated collection of Revit-focused functionality, providing access to a wide variety of Revit API operations through Dynamo.

### 🎨 UI Library

Pickles includes a custom UI library supporting more advanced Dynamo workflows, including:

* Custom dropdown nodes
* Dynamo View Extensions
* Custom WPF interfaces
* Additional UI components and utilities

### 🥒 Data Pickling

Pickles introduces a data pickling system for Dynamo, allowing data to be stored within a graph and accessed by Pickles nodes and UI components.

This provides a convenient way to persist information within Dynamo graphs without relying on external files or databases.
