...
namespace PicklesUI
{
    ...
    [NodeDescription("Select from a list of pickled objects, which can then be unpickled in your graph.\n\n" +
        "This node draws upon the third pickled key in the graph.\n\n" +
        "NOTE: Works in canvas and player.")]
    [IsDesignScriptCompatible]
    public class Pkl_SelectByKey3 : DropDownFactoryBaseCore<string>
    {
